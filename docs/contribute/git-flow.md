...
<!-- Title: Contributing GitFlow TerraformGithubPages -->
...
To contribute to terraform-github-pages project on [GitHub](https://github.com/hadenlabs/terraform-github-pages), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/terraform-github-pages/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to terraform-github-pages project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/terraform-github-pages.git
```

Now your **upstream** points to **hadenlabs/terraform-github-pages**.
...
git fetch upstream # assuming upstream is hadenlabs/terraform-github-pages
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/terraform-github-pages/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
